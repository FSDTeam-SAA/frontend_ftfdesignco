    ...
    <DialogContent className="sm:max-w-[900px] h-[800px] overflow-y-auto !rounded-xl bg-white">
      ...
      <DialogHeader className="px-6 pt-1 pb-4">
        <DialogTitle className="text-2xl font-bold text-center">
          <h2 className="text-[48px] text-[#131313] font-bold">
            {" "}
      ...
      <div className="px-6 pb-6 space-y-6">
        <div className="space-y-2">
          <Label
            className="text-[18px] text-[#131313] font-normal"
            htmlFor="company-unique-id"
          >
            Company Unique Id
          </Label>
          <Input
        ...
        {/* Company Logo Upload */}
        <div className="space-y-2">
          <Label className="text-[18px] text-[#131313] font-normal">
            Company Logo
          </Label>
          <div
            ...
            {logoPreview ? (
              ...
              <>
                ...
                <p className="text-xs text-gray-400">
                  Drag and drop images here or click to upload files
                </p>
              </>
            )}
            <input
