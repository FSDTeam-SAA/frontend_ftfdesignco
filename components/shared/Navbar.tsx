        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {isLoggedIn ? (
            <>
              ...
              {(role === "company_admin" || role === "employee") && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="bg-white w-48 cursor-pointer" align="end">
                    {role === "employee" ? (
                      <>
            ...
            <Link href="/login" className="hidden md:inline-flex">
              <Button className="bg-[#D9AD5E] rounded-[7px] hover:bg-[#f5b641] text-sm sm:text-base px-3 sm:px-4">Login</Button>
            </Link>
          )}
