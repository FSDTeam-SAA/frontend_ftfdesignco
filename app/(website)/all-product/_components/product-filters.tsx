          ...
          {categories.map((c) => (
            <div key={c._id} className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleCategoryChange(c.title, checked as boolean)}
              />
      ...
      <Card>
        ...
        <CardContent>
          <Slider
            ...
            max={1000}
            step={10}
            className="w-full bg-gray-300 rounded-full text-gray-300"
          />
          <div className="flex mt-5 justify-between text-sm text-gray-600">
